...
6. Security: The security of the MAC relies on the secret key \( K \) and the strength of the hash function \( H \), ensuring that an attacker cannot forge a valid MAC without knowledge of the key.
...
<img width="1602" height="886" alt="image" src="https://github.com/user-attachments/assets/be8f452f-1768-4e07-aafd-23ce9eee50a8" />
